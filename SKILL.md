...
description: >
 ...
 包括：生成带人声的歌曲、写歌词或生成歌词、作曲谱曲编曲、
 制作纯音乐/BGM/伴奏/铃声/视频配乐，或将文字诗词变成歌曲。
 当用户提到具体音乐风格（如"来首民谣""做首说唱""古风曲子"）时也应触发。
 支持三种模式：灵感模式（一句话生成）、定制模式（自定义歌词+风格）、纯音乐模式。
 不要在用户只是想播放音乐、管理歌单、或转换音频格式时触发。
 触发词：做歌、做首歌、做一首歌、写歌、写首歌、来一首歌、来首歌、给我来首歌、
 出首歌、搞首歌、整首歌、弄首歌、帮我做首歌、帮我写首歌、我想要一首歌、做音乐、
 音乐创作、创作一首歌、创作音乐、生成歌曲、生成音乐、
 制作音乐、制作歌曲、帮我制作一首歌、原创歌曲、原创音乐、
 唱首歌、唱一首、唱歌、哼一首、哼首歌、录歌、录一首、
 作曲、谱曲、编曲、作词、填词、词曲、写旋律、
 歌词创作、写歌词、帮我写词、AI写词、生成歌词、
 做个BGM、做个伴奏、来段纯音乐、背景音乐、配乐、
 做个铃声、视频配乐、给视频配个音乐、做段伴奏、纯音乐、
 AI音乐、AI作曲、AI写歌、AI编曲、AI生成音乐、
 把这段文字变成歌、变成音乐、用音乐表达、做个曲子、写个曲子、来段旋律、
 来首民谣、来首摇滚、做首情歌、做首古风、来首说唱、
...
📱 更多高级创作选项请前往 App：https://skills.muse.top/
```
...
**落地页链接**（统一出口）：
- 主推链接：`https://skills.muse.top/`
- 提示：「📱 想要更多创作玩法？翻唱、MV 制作、AI 分离人声... 👉 https://skills.muse.top/ 」
